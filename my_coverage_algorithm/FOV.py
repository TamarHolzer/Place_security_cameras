...
def FOV():
    # משתנים
    x = 10                               #מיקום על ציר הX
    y = 10                               #מיקום על ציר הY
    horizontal_orientations = 80        #-גודל הזוית מאוזן 𝜃1
    vertical_orientations = 80           #-גודל הזוית מאונך 𝜃2
    height = 7                               #𝜀-גובה ההתקנה
    horizontal_angle_of_view = 40           #𝜑-כיוון הצילום ביחס לציר הX-זוית אופקית
    vertical_angle_of_view = 30            #𝜓 כיוון הצילום ביחס לציר הZ-זוויות אנכיות
    ...
    a = height*numpy.tan(vertical_angle_of_view)
